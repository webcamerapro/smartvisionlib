...
namespace eLibNet4Core.Helpers
{
    ...
    public static class ExceptionHelper
    {
        ...
        /// <summary>
        ///     Выбрасывает новое исключение с указанным сообщением и информацией о вызывающем методе.
        /// </summary>
        ...
        /// <summary>
        ///     Выбрасывает новое исключение с указанным сообщением, кодом и информацией о вызывающем методе.
        /// </summary>
        /// <param name="message">Сообщение.</param>
