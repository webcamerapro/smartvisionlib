...
namespace eLibNet4Core.Extensions
{
    ...
    public static class UriExtensions
    {
        ...
        [CanBeNull]
        public static string GetRightAfterSegment(this Uri target, [NotNull] string segment)
        {
        ...
        [CanBeNull]
        public static string GetRightAfterSegments(this Uri target, [NotNull] [ItemNotNull] params string[] segments)
        {
            string previousSegment = null;
        ...
        [CanBeNull]
        public static string GetRightAfterSegmentsPriority(this Uri target, [NotNull] [ItemNotNull] params string[] segments) => segments.Select(segment => GetRightAfterSegment(target, segment)).FirstOrDefault(result => result != null);
    }
}