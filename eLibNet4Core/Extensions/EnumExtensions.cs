...
namespace eLibNet4Core.Extensions
{
    ...
    public static class EnumExtensions
    {
        ...
        public static string GetDescription(this Enum target) =>
            target.GetType().GetField(target.ToString())?.GetCustomAttributes(typeof(DescriptionAttribute), false) is DescriptionAttribute[] attributes && attributes.Length > 0 ? attributes[0].Description : string.Empty;
    }
}