...
public static class DbDataReaderExtensions
{
    ...
    public static bool? GetNBoolean(this DbDataReader target, int index) => target.IsDBNull(index) ? null : target.GetBoolean(index);
    ...
    public static async Task<bool?> GetNBooleanAsync(this DbDataReader target, int index, CancellationToken cancellationToken = default) =>
        await target.IsDBNullAsync(index, cancellationToken) ? null : await target.GetBooleanAsync(index, cancellationToken);
    ...
    public static short? GetNInt16(this DbDataReader target, int index) => target.IsDBNull(index) ? null : target.GetInt16(index);
    ...
    public static async Task<short?> GetNInt16Async(this DbDataReader target, int index, CancellationToken cancellationToken = default) =>
        await target.IsDBNullAsync(index, cancellationToken) ? null : await target.GetInt16Async(index, cancellationToken);
    ...
    public static int? GetNInt32(this DbDataReader target, int index) => target.IsDBNull(index) ? null : target.GetInt32(index);
    ...
    public static async Task<int?> GetNInt32Async(this DbDataReader target, int index, CancellationToken cancellationToken = default) =>
        await target.IsDBNullAsync(index, cancellationToken) ? null : await target.GetInt32Async(index, cancellationToken);
    ...
    public static long? GetNInt64(this DbDataReader target, int index) => target.IsDBNull(index) ? null : target.GetInt64(index);
    ...
    public static async Task<long?> GetNInt64Async(this DbDataReader target, int index, CancellationToken cancellationToken = default) =>
        await target.IsDBNullAsync(index, cancellationToken) ? null : await target.GetInt64Async(index, cancellationToken);
    ...
    public static DateTime? GetNDateTime(this DbDataReader target, int index) => target.IsDBNull(index) ? null : target.GetDateTime(index);
    ...
    public static async Task<DateTime?> GetNDateTimeAsync(this DbDataReader target, int index, CancellationToken cancellationToken = default) =>
        await target.IsDBNullAsync(index, cancellationToken) ? null : await target.GetDateTimeAsync(index, cancellationToken);
    ...
    public static float? GetNFloat(this DbDataReader target, int index) => target.IsDBNull(index) ? null : target.GetFloat(index);
    ...
    public static async Task<float?> GetNFloatAsync(this DbDataReader target, int index, CancellationToken cancellationToken = default) =>
        await target.IsDBNullAsync(index, cancellationToken) ? null : await target.GetFloatAsync(index, cancellationToken);
    ...
    public static decimal? GetNDecimal(this DbDataReader target, int index) => target.IsDBNull(index) ? null : target.GetDecimal(index);
    ...
    public static async Task<decimal?> GetNDecimalAsync(this DbDataReader target, int index, CancellationToken cancellationToken = default) =>
        await target.IsDBNullAsync(index, cancellationToken) ? null : await target.GetDecimalAsync(index, cancellationToken);
