...
public static class JTokenExtensions
{
    ...
    public static bool IsEmpty([NotNullWhen(false)] this JToken? target) => target == null || target.Type == JTokenType.Null || (target.Type == JTokenType.String && target.ToString().IsEmpty());
}